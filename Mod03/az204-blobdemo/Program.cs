...
namespace az204_blobdemo
{
  class Program
  {
    ...
    private static async Task ProcessAsync()
    {
      ...
      string storageConnectionString = "DefaultEndpointsProtocol=https;AccountName=az204blobdemo73449;AccountKey=LddG/Fwdf8iR8pR38uCqM+GD/vwgH8j9t4hKq9n6GvYSyFDmhC+j1XAzxAeOZpWrth1WpnsMhtz6zLEy2xKV6w==;EndpointSuffix=core.windows.net";
